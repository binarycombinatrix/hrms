...
const Education = ({
  ...
  const [educationMaster, setEducation] = useState([]);
  const [courseMaster, setCourse] = useState([]);
  ...
  useEffect(() => {
    const getMaster = async () => {
      const resOne = await axios.get("/education");
      const resTwo = await axios.get("/course");
      if (resOne.success === true && resTwo.success === true) {
        setEducation(resOne.data);
        setCourse(resTwo.data);
      }
    };
    getMaster();
  }, []);
                ...
                <div className="form-row" key={educationIndex}>
                  <FormGroup className="col-md-2">
                    ...
                    >
                      ...
                      {educationMaster.map((educationItem, idx) => (
                        <option value={educationItem.id}>
                          {educationItem.title}
                        </option>
                      ))}
                    </CustomInput>
                  ...
                  <FormGroup className="col-md-2">
                    ...
                    >
                      ...
                      {courseMaster.map((courseItem, idx) => (
