...
const AddCompany = () => {
  ...
  const [form, setForm] = useState(!state ? initialFormState : state);
  ...
  const validate = () => {
    ...
    // if (form.streetLine1.length < 10) {
    //   handleErrorChange({
    //     streetLine1: {
    //       inValid: true,
    //       errorMsg: "Provide proper streetline 1 address.",
    //     },
    //   });
    //   flag = false;
    // }

    // if (form.streetLine2.length < 10) {
    //   handleErrorChange({
    //     streetLine2: {
    //       inValid: true,
    //       errorMsg: "Provide proper streetline 2 address.",
    //     },
    //   });
    //   flag = false;
    // }

    // if (form.area.length < 5) {
    //   handleErrorChange({
    //     area: {
    //       inValid: true,
    //       errorMsg: "Provide proper area.",
    //     },
    //   });
    //   flag = false;
    // }
    ...
    // if (form.appraisalCycle !== "") {
    //   handleErrorChange({
    //     appraisalCycle: {
    //       inValid: true,
    //       errorMsg: "Select appraisal cycle",
    //     },
    //   });
    //   flag = false;
    // }
    ...
    // if (
    //   form.bondDurationForExperienced ||
    //   !Number(form.bondDurationForExperienced)
    // ) {
    //   handleErrorChange({
    //     bondDurationForExperienced: {
    //       inValid: true,
    ...
    //     notes: {
    //       inValid: true,
    //       errorMsg: "More than 10 character.",
    //     },
    //   });
    //   flag = false;
    // }
  ...
  const handleContact = async (e) => {
    ...
    if (!isValid) {
      try {
        const res = await axios.put(`/company/${form.id}`, form);
        if (res.status) {
        ...
        <CardBody>
          <form onSubmit={handleContact}>
            <div className="form-row">
              ...
              <FormGroup className="col-md-4">
                <Label for="noticePeriod">Notice Period [ In digit ]</Label>
                <Input
                  type="text"
                  id="noticePeriod"
              ...
              <FormGroup className="col-md-4">
                <Label for="bondDurationForExperienced">
                  Bond Duration Experienced [ In digit ]
                </Label>
                <Input
                  type="text"
              ...
              <FormGroup className="col-md-4">
                <Label for="bondDurationForFreshers">
                  Bond Duration Freshers [ In digit ]
                </Label>
                <Input
                  type="text"
              ...
              <FormGroup className="col-md-4">
                ...
                >
                  ...
                  <option>First and Thired saturaday</option>
                  <option>second and Thired saturaday</option>
                </CustomInput>
